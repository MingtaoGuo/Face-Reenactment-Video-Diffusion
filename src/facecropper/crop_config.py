...
class CropConfig(PrintableConfig):
    insightface_root: str = ""#make_abs_path("/media/Data/gmt/Research/PoseIdentityGuidance/immersivepa/facecropper/pretrained_weights/insightface")
    landmark_ckpt_path: str = ""#make_abs_path("/media/Data/gmt/Research/PoseIdentityGuidance/immersivepa/facecropper/pretrained_weights/landmark.onnx")
