...
class InferenceConfig(PrintableConfig):
    ...
    checkpoint_F: str = ""  # path to checkpoint
    checkpoint_M: str = ""  # path to checkpoint
    checkpoint_G: str = ""  # path to checkpoint
    checkpoint_W: str = ""  # path to checkpoint

    checkpoint_S: str = ""  # path to checkpoint
